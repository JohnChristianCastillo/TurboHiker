...
public:
         ...
         */
        static std::shared_ptr<MainCharacter> generateMainCharacter(int lanes);

        /**
         * Generates the finish line
         * @return a pointer to the finish line
         */
        static std::shared_ptr<Finish> generateFinishLine();
         ...
         */
        static std::vector<std::shared_ptr<PowerUp>> generatePowerUp();
         ...
         */
        static std::shared_ptr<PowerUp> generateRandomPowerUp(const float& randomOffset);
